...
# img = cv2.imread('F:\projects\Image Processing\Project\testimg.jpeg',cv2.IMREAD_COLOR)
img = cv2.imread(r"F:\projects\Im-Proc-Proj\testimg.jpeg",cv2.IMREAD_COLOR)
...
# #edged = out_binary - ndimage.morphology.binary_dilation(out_binary)
# #cv2.imshow('Edge detected 2 ',edged)
